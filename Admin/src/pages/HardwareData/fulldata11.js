...
const Fulldata = () => {
  ...
  const tableColumns = [
    ...
    { label: "Attributes", field: "attributes", sort: "asc", width: 150 },
    { label: "Action", field: "action", sort: "asc", width: 200, render: (row) => (
        <div>
