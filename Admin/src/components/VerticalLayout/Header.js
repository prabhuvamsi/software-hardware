              ...
              <div className="navbar-brand-box">
                <Link to="/" className="logo logo-dark">
                  <span className="logo-sm">
                    <img src={"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTK5bH09wRnHn9nohTY4YZw81N3BPDns3LGHFpYzZaq5q6kqCuTMLCKE-igqkNLg7oiGNc&usqp=CAU"} alt="" height="20" />
                  </span>
                  <span className="logo-lg">
                    <img src={"https://encryptedtbn0.gstatic.com/images?q=tbn:ANd9GcTK5bH09wRnHn9nohTY4YZw81N3BPDns3LGHFpYzZaq5q6kqCuTMLCKE-igqkNLg7oiGNc&usqp=CAU"} alt="" height="19" />
                  </span>
                </Link>

                <Link to="/" className="logo logo-light">
                  <span className="logo-sm">
                    <img src={"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTK5bH09wRnHn9nohTY4YZw81N3BPDns3LGHFpYzZaq5q6kqCuTMLCKE-igqkNLg7oiGNc&usqp=CAU"} alt="" height="80" />
                  </span>
                  <span className="logo-lg">
